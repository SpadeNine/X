...
load_from='work_dirs/mask2former_r50_query-100_100e_crowd_ai/epoch_100.pth'
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file='/home/wex/dataset/crowdai/val/annotation-small.json',
...
#             project = 'mmdetection',
#             entity = 'tum-tanmlh',
#             name = 'vis_polygonizer_v20_cv2_no-dice_angle-loss_lam-4_r50_query-100_80k_crowd_ai',
#             resume = 'never',
#             dir = './work_dirs/',
